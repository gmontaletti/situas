---
title: "Download Classification Standards"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Download Classification Standards}
...
The Italian Ministry of Labor and Social Policies maintains official classification standards used in administrative data systems (URP - Unita Raccolta Permessi). These classifications are published as Excel files at:
...
These are listed as "Suggests" dependencies, so they are optional if you do not need this functionality.
